        ...
        <div className="flex h-screen">
            ...
            <div className="hidden lg:flex lg:w-1/2 bg-black items-center justify-center relative overflow-hidden">
                ...
                <div className="relative z-10 p-12 text-white max-w-lg">
                    <h2 className="text-4xl font-bold mb-6">Welcome to Murai</h2>
                    <p className="text-lg text-gray-300">
                        Join our platform to protect and monitor your family's online activities.
                        Stay informed and ensure a safer digital environment.
                    </p>
                </div>
            </div>
